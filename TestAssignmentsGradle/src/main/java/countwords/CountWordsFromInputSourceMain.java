...
public class CountWordsFromInputSourceMain {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String stringObj = new String(Files.readAllBytes(Paths.get(args[0])), charset);

        // create of map of words (using "\\W+" regex)
        Map<String, Integer> wordsMap = convertTextToWordsMap(stringObj, wordSplitRegex);
